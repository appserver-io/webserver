...
class Rule
{
     ...
     *            Condition string e.g. "^_Resources/.*" or "-f{OR}-d{OR}-d@$REQUEST_FILENAME"
     * @param string|array $target
     *            The target to rewrite to, might be null if we should do nothing
     * @param string $flagString
     *            A flag string which might be added to to the rule e.g. "L" or "C,R"
     */
     ...
     * @param array $serverBackreferences
     *            Server backreferences
     *            
     ...
     *            The request's context
     * @param \AppserverIo\Psr\HttpMessage\ResponseInterface $response
     *            The response instance to be prepared
     *            
     * @return void
     */
